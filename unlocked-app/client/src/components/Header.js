  ...
  return (
    <header>
      <nav className="navbar navbar-expand-sm fixed-top navbar-light bg-light">
        <Link className="navbar-brand" to="/">Unlocked</Link>
        ...
        <div className="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup">
          {auth().currentUser
            ? <div className="navbar-nav">
              <Link className="nav-item nav-link mr-3" to="/free">Free</Link>
              <Link className="nav-item nav-link mr-3" to="/paid">Paid</Link>
            ...
            : <div className="navbar-nav">
              <Link className="nav-item nav-link mr-3" to="/public">Public</Link>
